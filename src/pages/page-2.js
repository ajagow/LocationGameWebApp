...
import { Terrene_H5, Terrene_H3, Terrene_H2 } from "../components/base_components/typography";
...
const SecondPage = () => {
  ...
  <Background>
    ...
    <T_H3>Please begin by either joining an existing lobby or creating your own.</T_H3>
  </FormContainer>
  <FormContainer>
