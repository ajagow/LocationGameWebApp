...
const clues = [
  {id: 1, questName: "Finding the Dragon", clue: "hints/hint2.png"},
  {id: 2, questName: "Hiding the Dragon", clue: "hints/hint2.png"},
  {id: 3, questName: "Saving the Dragon", clue: "hints/hint3.png"},
  {id: 4, questName: "Freeing the Dragon", clue: "hints/hint2.png"},
];
...
export class ClueList extends React.Component {
    ...
    for (let i = 0; i < clues.length; i++) { 
        const quest = clues[i];
          ...
          if (isSolved) {
            ...
            const listItem = <ClueContainerSolved item xs={5}>
            <ClueImg src={clueImg}/>
            ...
            const listItem = <ClueContainerUnsolved item xs={5}>
  ...
  return (
    <ClueListContainer>
    <Terrene_H3>Chapter 1: The Pivot</Terrene_H3>
    {this.state.showList && 
