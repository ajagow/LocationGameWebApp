export const story = [
  {
    ...
    story: [
      ...
      {
        text:
          "College friends Quinn, Alex, Jamie and Sam were sitting in their dorm room watching an episode of The Bachelor together when...",
        image: "prologue_2.png",
      },
      {
        text: "",
        image: "prologue_3.png",
      },
      {
        text:
          "This just in: News Reporter Robert Lovehate has just been reported missing.  He was last seen driving North on Highway 83 3 days ago.  Foul play is suspected.",
  ...
  },
  {
    ...
    story: [
      {
        text:
          "Having closed as many of the portals as possible, the group reassembles at Quinn's apartment.",
        image: "",
      },
      {
      ...
      {
        text:
          "Hi Alex, Sam, Jamie, and Quinn. This is Robert Lovehate. Thanks for helping me with these pesky portals. I knew you were just the people for the job.",
        image: "",
      },
      {
      ...
      {
        text:
          "urrrr EEEE urrr NNNGGGG CRRRRcrrrr KEEEEEEE grrr nnnnnng - all of the group's Gateway Killers go off at once.",
        image: "",
      },
      {
        text:
          "TERRENE PORTAL SIGNAL DETECTED. LOCATION UNKNOWN. ROGUE SIGNAL, DANGER. DANGER.",
        image: "",
      },
      {
      ...
      {
        text:
          "Yes. I don't have time to explain now, but an unstable gateway is going to open up, and we can't let that happen. ",
        image: "",
      },
      {
        text: "Can we stop it?",
      ...
      {
        text:
          "Yes, but have you ever heard of the uncertainty principle? There is no way for us to be certain where the gateway will open up. My projections have narrowed it down to the following four locations:",
        image: "",
      },
      {
        text:
          "Use information you collected from the portals you closed in order to figure out where it will open up.",
        image: "",
      },
      {
        text: "But how?",
